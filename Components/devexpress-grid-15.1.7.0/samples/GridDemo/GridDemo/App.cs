...
namespace DevExpress.GridDemo {
    ...
    public class DemoInfo : BindableObject {
        public static readonly BindableProperty TitleProperty = BindableProperty.Create<DemoInfo, string>(o => o.Title, default(string));
        public string Title {
            get { return (string)GetValue(TitleProperty); }
            set { SetValue(TitleProperty, value); }
        }
        public static readonly BindableProperty ShortDescriptionProperty = BindableProperty.Create<DemoInfo, string>(o => o.ShortDescription, default(string));
        public string ShortDescription {
            get { return (string)GetValue(ShortDescriptionProperty); }
            set { SetValue(ShortDescriptionProperty, value); }
        }
        public static readonly BindableProperty HideAdditionalPagesProperty = BindableProperty.Create<DemoInfo, bool>(o => o.HideAdditionalPages, default(bool));
        ...
        //}
        public static readonly BindableProperty IsVisibleProperty = BindableProperty.Create<DemoInfo, bool>(o => o.IsVisible, true);
        public bool IsVisible {
            get { return (bool)GetValue(IsVisibleProperty); }
            set { SetValue(IsVisibleProperty, value); }
        }
        public static readonly BindableProperty IsSelectedProperty = BindableProperty.Create<DemoInfo, bool>(o => o.IsSelected, false);
